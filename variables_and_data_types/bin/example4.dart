void main(List<String> args) {
  ...
  // if you gave String data type and you assign int yo that variable then you get error at compile time
  ...
  // you gave give any data it can be int ,String or any other data type also.
